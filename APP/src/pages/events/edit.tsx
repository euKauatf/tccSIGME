      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="flex flex-col divp rounded-[20px] p-6 sm:p-8 bg-emerald-50 shadow-lg min-h-[170px]">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div>
              <label
                htmlFor="email_palestrante"
                className="block text-sm font-medium text-gray-700">
                Email
              </label>
              <input
                type="text"
                id="email_palestrante"
                disabled
                name="email_palestrante"
                value={formData.email_palestrante || ""}
                onChange={handleChange}
                className="block w-full mt-1 input input-bordered"
                required
              />
            ...
            <div>
              ...
              <IMaskInput
                mask="(00) 00000-0000"
                disabled
                id="telefone_palestrante"
                name="telefone_palestrante"
                value={formData.telefone_palestrante || ""}
                placeholder="(00) 00000-0000"
                className="w-full input input-bordered"
                required
                onAccept={(value) => {
                  handleChange({
                    target: { name: "telefone_palestrante", value: value },
            ...
            <div>
              ...
              <select
                ...
                value={formData.data || ""}
                onChange={handleChange}
                className="block w-full mt-1 select select-bordered"
                required>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                className="block w-full h-24 mt-1 textarea textarea-bordered"
                required
              />
            </div>
